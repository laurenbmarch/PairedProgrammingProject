...
{   // Hiding Spot is: Outside- shed- in the trashcan
    class HideAndSeekGame2
    {
        public void Run()
        {
            // Answer is Outside, in the shed, in the trashcan
            string correctHidingLevelOne = "outside";
            string correctHidingLevelTwo = "shed";
            string correctHidingLevelThree = "2"; //in the trash can
            //Series for when the user gets the first, second, and third question wrong THE FIRST TIME ASKED
            ...
            while (userGuessLevelOne != correctHidingLevelOne)
            {
                ...
                if (userGuessAgainLevelOne == correctHidingLevelOne)
                {
                    ...
                    Console.WriteLine("You're on the right track! Now, choose a place to look in: shed, woods, or playground?");
            ...
            Console.WriteLine("You're on the right track! Now, choose a room to look in: shed, woods, or playground?");
            string userGuessLevelTwo = Console.ReadLine().ToLower();
            while (userGuessLevelTwo != correctHidingLevelTwo)
            {
                Console.WriteLine("Nope, I'm not in there! Guess again: shed, woods, or playground?");
